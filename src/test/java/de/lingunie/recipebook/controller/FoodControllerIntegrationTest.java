...
import de.lingunie.recipebook.entity.FoodEntity;
...
class FoodControllerIntegrationTest {
    ...
    void test() throws Exception {
        final var exchange = this.testRestTemplate.exchange(
                "http://localhost:" + port + "/foods",
                HttpMethod.GET,
                null,
                new ParameterizedTypeReference<Iterable<FoodEntity>>() {}
        );
